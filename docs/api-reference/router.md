...
- [Routing Guide](/docs/routing/basics.md) - Getting started with routing
- [Navigation Guide](/docs/routing/navigation.md) - Links and navigation patterns
- [Dynamic Routes](/docs/routing/dynamic-routes.md) - Route parameters and patterns
- [Nested Layouts](/docs/routing/layouts.md) - Layout composition
- [Route Guards](/docs/routing/route-guards.md) - Authentication and authorization
- [Smart Preloading](/docs/routing/smart-preloading.md) - Intent prediction deep dive
- [View Transitions](/docs/routing/view-transitions.md) - Animation recipes
