...
For complete API documentation, see [Core API Reference: PPR](../api-reference/core.md#partial-pre-rendering-ppr)
...
- [Incremental Static Regeneration](./isr.md)
- [Performance Optimization](../best-practices/performance.md)
- [Caching Strategies](../data/caching-invalidation.md)
