...
- **[Lifecycle API](../core/components.md)**: Component lifecycle hooks
...
- **[Hydration API](../ssr/overview.md)**: Client-side hydration utilities

### @philjs/islands

Island architecture for partial hydration.

- **[Islands API](../ssr/islands.md)**: `Island`, `createIsland()`

### @philjs/devtools

Development tools and debugging.

- **[DevTools API](../tooling/devtools.md)**: Debug utilities and inspectors
...
Major version updates may include breaking changes. See the [Migration Guide](../migration/react.md) for upgrade instructions.
...
**Need help?** Check the [Observability Guide](../observability/overview.md) or ask in [GitHub Discussions](https://github.com/philjs/philjs/discussions).
