...
1. **[Core Concepts: Signals](../core/signals.md)** - Deep dive into signals
2. **[Core Concepts: Memos](../core/effects-memos.md)** - Master derived state
3. **[Core Concepts: Effects](../core/effects-memos.md)** - Handle side effects
...
**Next:** [Core Concepts: Components →](../core/components.md)
