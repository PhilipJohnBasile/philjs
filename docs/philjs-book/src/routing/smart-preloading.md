...
- [Route Discovery](./route-discovery.md) - Auto-discover routes
- [Performance](../performance/runtime.md) - Performance optimization
- [Code Splitting](../performance/code-splitting.md) - Split routes
...
**Next Steps:**
- Explore [View Transitions](./view-transitions.md) for animations
- Learn about [Route Discovery](./route-discovery.md)
- Optimize with [Code Splitting](../performance/code-splitting.md)
