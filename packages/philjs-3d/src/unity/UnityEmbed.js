 ...
 * ```
 */
export function UnityEmbed(props) {
...
function updateProgressBar(element, progress) {
    const fill = element.querySelector('.unity-progress-fill');
    const text = element.querySelector('.unity-progress-text');
    if (fill) {
...
//# sourceMappingURL=UnityEmbed.js.map