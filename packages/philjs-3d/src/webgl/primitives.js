 ...
 */
export function createTorus(radius = 0.5, tube = 0.2, radialSegments = 32, tubularSegments = 24) {
    const vertices = [];
    const normals = [];
    const uvs = [];
    const indices = [];
 ...
 */
export function createRoundedBox(width = 1, height = 1, depth = 1, radius = 0.1, segments = 4) {
