...
`;
  ...
  function generateHTTPAPIHandler(): string {
...
`;
  ...
  function generateCloudFrontHandler(): string {
...
`;
  ...
  function generateServerlessConfig(): string {
...
export function getAWSContext() {
  return (globalThis as any).awsContext;
}
...
export function getS3AssetUrl(key: string, bucket?: string): string {
