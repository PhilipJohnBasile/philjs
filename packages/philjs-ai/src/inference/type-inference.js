...
Return JSON:
{
  ...
  "suggestions": [
     ...
     */
    async inferFromUsage(code, variableName) {
...
Return JSON:
{
  ...
  "alternatives": ["other possible types"]
     ...
     */
    async inferFromJSON(json, typeName, options) {
...
Return JSON:
{
  ...
  "imports": ["any needed imports"]
     ...
     */
    async inferAPITypes(code, endpointName) {
...
Return JSON:
{
  ...
  "code": "all type definitions"
     ...
     */
    async suggestTypeImprovements(code) {
...
Return JSON array of TypeSuggestion objects.`;
     ...
     */
    async generateDeclarations(code, options) {
...
Return the complete .d.ts file.`;
     ...
     */
    async convertJSToTS(jsCode, options) {
...
Return JSON:
{
  ...
  "changes": [
     ...
     */
    async inferComponentProps(componentCode) {
...
Return JSON matching InferredInterface:
{
  ...
  "code": "interface ComponentNameProps { ... }"
     ...
     */
    async detectTypeMismatches(code) {
...
Return JSON array.`;
    ...
    // Private Methods
    // ============================================================================
    getTypeInferenceSystemPrompt(options) {
 ...
 */
export function createTypeInferenceHelper(provider, options) {
    return new TypeInferenceHelper(provider, options);
}
/**
 * Quick type inference helper
 */
export async function inferTypesForCode(provider, code, options) {
 ...
 */
export async function jsonToTypeScript(provider, json, typeName) {
    const helper = new TypeInferenceHelper(provider);
 ...
 */
export async function convertJavaScriptToTypeScript(provider, jsCode) {
    const helper = new TypeInferenceHelper(provider);
