...
export function buildComponentPrompt(description, options) {
...
export function buildRoutePrompt(description, path, options) {
...
export function buildTestPrompt(code, options) {
...
export function buildRefactorPrompt(code, focusAreas) {
...
export function buildReviewPrompt(code, filePath, aspects) {
...
export function buildMigrationPrompt(code, sourceFramework) {
...
export function buildErrorExplanationPrompt(error) {
    return `${SYSTEM_PROMPTS.philjs}
...
export function buildDocumentationPrompt(code, options) {
