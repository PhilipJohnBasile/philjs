...
export class PrivacyFirstAnalytics {
     ...
     */
    trackPageView(page) {
        if (!this.isTrackingAllowed() || !this.config.trackPageViews)
            return;
    ...
    saveConsent() {
        if (typeof localStorage === 'undefined' || !this.consent)
            return;
        try {
...
//# sourceMappingURL=privacy-first.js.map