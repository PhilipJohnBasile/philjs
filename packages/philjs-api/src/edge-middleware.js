...
function getRemovedHeaders(context) {
    const stored = context[removedHeadersKey];
    if (stored) {
        return stored;
    }
    const created = new Set();
    context[removedHeadersKey] = created;
    return created;
}
// ============================================================================
...
// ============================================================================
function createEdgeContext(request, geo, platform, fetcher) {
