...
export declare function useAuth(): {
    user: import("@philjs/core/signals").Memo<import("./types.js").User | null>;
    isAuthenticated: import("@philjs/core/signals").Memo<boolean>;
    token: import("@philjs/core/signals").Memo<string | undefined>;
