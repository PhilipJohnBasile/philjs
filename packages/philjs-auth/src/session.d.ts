...
export declare class SessionManager {
     ...
     */
    get user(): import("@philjs/core/signals").Memo<User | null>;
    /**
     * Computed signal for authentication status
     */
    get isAuthenticated(): import("@philjs/core/signals").Memo<boolean>;
    /**
     * Computed signal for token
     */
    get token(): import("@philjs/core/signals").Memo<string | undefined>;
    /**
     * Set user session
     */
