 ...
 * Batch 100 updates.
 */
export const batch100Updates: Benchmark = {
 ...
 * Batch 1000 updates.
 */
export const batch1000Updates: Benchmark = {
 ...
 * Batch 10000 updates.
 */
export const batch10000Updates: Benchmark = {
 ...
 */
export const unbatched1000Updates: Benchmark = {
 ...
 */
export const batchMultipleSignals: Benchmark = {
 ...
 * Nested batches.
 */
export const nestedBatches: Benchmark = {
 ...
 */
export const batchWithDerived: Benchmark = {
 ...
 */
export const batchDiamondDependency: Benchmark = {
 ...
 */
export const batchMultipleEffects: Benchmark = {
 ...
 * Batch return value.
 */
export const batchReturnValue: Benchmark = {
 ...
 */
export const interleavedBatch: Benchmark = {
 ...
 */
export const batchArrayOperations: Benchmark = {
...
export const batchBenchmarks: Benchmark[] = [
  batch100Updates,
  batch1000Updates,
  batch10000Updates,
