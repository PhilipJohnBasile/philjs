 ...
 * Create 10k effects.
 */
export const create10kEffects: Benchmark = {
 ...
 * Create 1k effects.
 */
export const create1kEffects: Benchmark = {
 ...
 */
export const effectSingleDependency: Benchmark = {
 ...
 */
export const effectMultipleDependencies: Benchmark = {
 ...
 */
export const effectCleanup: Benchmark = {
 ...
 */
export const effectDisposal: Benchmark = {
 ...
 * Nested effects.
 */
export const nestedEffects: Benchmark = {
  ...
  fn: async () => {
    ...
    if (innerDispose) disposes.push(innerDispose);
 ...
 */
export const conditionalDependencies: Benchmark = {
 ...
 */
export const effectInRoot: Benchmark = {
 ...
 */
export const manyEffectsSameSignal: Benchmark = {
 ...
 */
export const effectExecutionOrder: Benchmark = {
...
export const effectBenchmarks: Benchmark[] = [
  create10kEffects,
  create1kEffects,
