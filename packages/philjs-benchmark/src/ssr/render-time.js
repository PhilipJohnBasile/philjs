 ...
 */
export const renderSimpleElements = {
 ...
 */
export const renderDeepNesting = {
 ...
 */
export const renderWithFragments = {
    name: 'ssr-render-fragments-1k',
    iterations: 50,
    fn: async () => {
        const items = Array.from({ length: 1000 }, (_, i) => jsx(Fragment, {
            children: [
 ...
 */
export const renderManyAttributes = {
    name: 'ssr-render-many-attributes',
    iterations: 100,
    fn: async () => {
        const elements = Array.from({ length: 100 }, (_, i) => jsx('div', {
            id: `elem-${i}`,
 ...
 */
export const renderWithSignals = {
 ...
 */
export const measureOutputSize = {
...
export const renderTimeBenchmarks = [
...
//# sourceMappingURL=render-time.js.map