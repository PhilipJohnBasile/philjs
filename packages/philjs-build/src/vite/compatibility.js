...
export function viteAdapter(options = {}) {
...
export function createViteCompatibleConfig(options = {}) {
...
export function convertRspackToVite(rspackConfig) {
    const mapped = mapRspackOptionsToVite(rspackConfig);
    const build = { ...(mapped.build ?? {}) };
...
export function mapRspackPluginToVite(plugin) {
...
export function mapRspackLoaderToVite(loader) {
...
function normalizeLoaderUse(use) {
    if (!use)
        return [];
