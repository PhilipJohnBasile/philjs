 ...
 */
export declare const CellContext: import("@philjs/core").Context<CellContextValue>;
/**
 * SSR Context for server-side rendering
 */
export declare const CellSSRContext: import("@philjs/core").Context<CellSSRContextType | null>;
 ...
 * ```
 */
export declare function CellProvider(props: CellProviderProps): import("@philjs/core").JSXElement;
 ...
 * ```
 */
export declare function CellSSRProvider(props: CellSSRProviderProps): import("@philjs/core").JSXElement;
/**
