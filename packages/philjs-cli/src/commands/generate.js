...
import { runInteractiveMode, promptModelFields, } from '../prompts.js';
import { loadConfig, getGeneratorConfig } from '../config.js';
import { generateComponent, generatePage, generateApi, generateModel, generateScaffold, generateHook, generateContext, generateRoute, generateStore, generateAuth, generateRSS, generateSitemap, } from '../generators/index.js';
/**
...
export function registerGenerateCommand(program) {
    ...
    modelCmd
        ...
        try {
            ...
            const provider = (options.provider ?? config.database?.provider);
    ...
    scaffoldCmd
        ...
        try {
            ...
            const scaffoldProvider = (options.provider ?? config.database?.provider);
