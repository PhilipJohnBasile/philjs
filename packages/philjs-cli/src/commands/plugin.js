...
import { CLIPluginManager, formatPluginList, formatSearchResults, } from "../plugin-manager.js";
/**
...
export function registerPluginCommands(program) {
    ...
    plugin
        ...
        try {
            ...
            await manager.install(pluginName, installOptions);
        }
        catch (error) {
            process.exit(1);
        }
    ...
    plugin
        ...
        const manager = new CLIPluginManager();
        // Search by category
        const setupSearchOptions = { limit: 50 };
