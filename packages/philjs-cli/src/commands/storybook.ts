 ...
 */
async function initStorybook(port: string) {
...
async function generateStory(options: {
  component: string;
  directory?: string;
  type: 'component' | 'route' | 'form' | 'island';
}) {
 ...
 */
function generateRouteStory(componentName: string): string {
  return `import type { Meta, StoryObj } from 'philjs-storybook';
import { ${componentName} } from './${componentName}';
 ...
 */
function generateFormStory(componentName: string): string {
  return `import type { Meta, StoryObj } from 'philjs-storybook';
import { ${componentName} } from './${componentName}';
 ...
 */
function generateIslandStory(componentName: string): string {
  return `import type { Meta, StoryObj } from 'philjs-storybook';
import { ${componentName} } from './${componentName}';
