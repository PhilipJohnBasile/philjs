 ...
 */
export async function generateAuth(options: AuthGeneratorOptions): Promise<void> {
  const {
    provider,
    directory = 'src',
    typescript = true,
 ...
 */
function generateClerkConfig(ts: boolean): string {
  return `/**
 ...
 */
function generateAuth0Config(ts: boolean): string {
  return `/**
 ...
 */
function generateSupabaseConfig(ts: boolean): string {
  return `/**
 ...
 */
function generateNextAuthConfig(ts: boolean): string {
  return `/**
 ...
 */
function generateCustomConfig(ts: boolean): string {
  return `/**
 ...
 */
async function generateAuthProvider(
  provider: AuthProvider,
  authDir: string,
  typescript: boolean
): Promise<void> {
...
function generateClerkProvider(ts: boolean): string {
  return `/**
...
function generateAuth0Provider(ts: boolean): string {
  return `/**
...
function generateSupabaseProvider(ts: boolean): string {
  return `/**
...
function generateNextAuthProvider(ts: boolean): string {
  return `/**
...
function generateCustomProvider(ts: boolean): string {
  return `/**
 ...
 * Generate auth hooks
 */
async function generateAuthHooks(
  provider: AuthProvider,
  authDir: string,
  typescript: boolean
): Promise<void> {
...
function generateClerkHooks(ts: boolean): string {
  return `/**
...
function generateAuth0Hooks(ts: boolean): string {
  return `/**
...
function generateSupabaseHooks(ts: boolean): string {
  return `/**
...
function generateNextAuthHooks(ts: boolean): string {
  return `/**
...
function generateCustomHooks(ts: boolean): string {
  return `/**
 ...
 */
async function generateSignupForm(
  provider: AuthProvider,
  uiDir: string,
  ext: string
): Promise<void> {
 ...
 */
async function generateProfileForm(
  provider: AuthProvider,
  uiDir: string,
  ext: string
): Promise<void> {
 ...
 */
async function generateProtectedRouteUtils(
  provider: AuthProvider,
  authDir: string,
  ext: string
): Promise<void> {
 ...
 */
async function generateAuthGuard(
  provider: AuthProvider,
  authDir: string,
  ext: string
): Promise<void> {
 ...
 * Generate .env.example
 */
async function generateEnvExample(provider: AuthProvider): Promise<void> {
