...
import { createContext, toPascalCase, } from './template-engine.js';
/**
 * Generate a component
 */
export async function generateComponent(options) {
    const { name, directory = 'src/components', typescript = true, withTest = true, withStyles = false, styleType = 'css-modules', } = options;
...
function generateComponentTemplate(context) {
...
function generateIndexTemplate(context) {
