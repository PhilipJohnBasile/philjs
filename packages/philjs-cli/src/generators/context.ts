 ...
 */
export async function generateContext(options: ContextOptions): Promise<string[]> {
  const {
    name,
...
function generateContextTemplate(name: string, camelName: string, typescript: boolean): string {
  return `/**
 * ${name} Context
 *
...
function generateHookTemplate(name: string, camelName: string, typescript: boolean): string {
  return `/**
...
function generateIndexTemplate(name: string, typescript: boolean): string {
  if (typescript) {
...
function generateTestTemplate(name: string, camelName: string, typescript: boolean): string {
