 ...
 */
export async function generateRoute(options: RouteOptions): Promise<string[]> {
  const {
    name,
...
function generateRouteTemplate(
  name: string,
  routePath: string,
  routeParams: string[],
  isDynamic: boolean,
...
function generateLoaderTemplate(
  name: string,
  routeParams: string[],
  isDynamic: boolean,
  typescript: boolean
...
function generateActionTemplate(
  name: string,
  routeParams: string[],
  isDynamic: boolean,
  typescript: boolean
...
function generateTestTemplate(name: string, routePath: string, typescript: boolean): string {
