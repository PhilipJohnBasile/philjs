...
function generateStoreTemplate(storeName, pascalName, camelName, typescript) {
...
function generateTestTemplate(storeName, pascalName, camelName, typescript) {
...
async function updateIndexFile(storeDir, storeName, camelName, typescript) {
