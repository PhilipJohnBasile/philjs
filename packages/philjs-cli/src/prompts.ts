 ...
 */
export async function promptGeneratorType(): Promise<GeneratorType | null> {
 ...
 */
export async function promptName(type: GeneratorType): Promise<string | null> {
  const examples: Record<GeneratorType, string> = {
 ...
 */
export async function promptModelFields(): Promise<ModelField[]> {
 ...
 */
export function parseFieldDefinition(definition: string): ModelField | null {
