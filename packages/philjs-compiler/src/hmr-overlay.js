 ...
 */
function getDefaultSuggestion(type) {
    const suggestions = {
 ...
 */
function renderOverlayContent(error) {
 ...
 */
export function showHMRErrorOverlay(error) {
    // Add to error list
 ...
 */
export function hideHMRErrorOverlay() {
...
export function setupOverlayHandlers() {
    ...
    // Rollback handler
    window.__philjs_hmr_rollback = async () => {
        hideHMRErrorOverlay();
        try {
    ...
    // Reload handler
    window.__philjs_hmr_reload = () => {
        window.location.reload();
    };
    // Dismiss handler
    window.__philjs_hmr_dismiss = () => {
        hideHMRErrorOverlay();
    };
 ...
 * Get error history
 */
export function getHMRErrorHistory() {
    return [...state.errors];
}
/**
 * Clear error history
 */
export function clearHMRErrorHistory() {
    state.errors = [];
    state.retryCount = 0;
}
...
//# sourceMappingURL=hmr-overlay.js.map