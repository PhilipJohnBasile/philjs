...
export function transform(code, filePath, config = {}) {
    const hasPhilJSImport = code.includes('@philjs/core') ||
...
export { showHMRErrorOverlay, hideHMRErrorOverlay, getHMRErrorHistory, clearHMRErrorHistory, } from './hmr-overlay.js';
