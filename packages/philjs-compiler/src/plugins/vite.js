...
export default function philJSCompiler(options = {}) {
    const { enabled = true, verbose = false, cache = true, preserveHmrState = true, enhancedErrors = true, filter: customFilter, include: includeOpt, exclude: excludeOpt, ...compilerConfig } = options;
