 ...
 */
export function generatePackageJsonFields(options) {
    const config = { ...defaultLibraryConfig, ...options };
...
export async function validateLibraryBuild(distPath, options) {
    const errors = [];
    const warnings = [];
    const config = { ...defaultLibraryConfig, ...options };
 ...
 */
export function printLibraryBuildReport(validation) {
