 ...
 */
export function createProductionPreset(options = {}) {
 ...
 */
export function createProductionViteConfig(options = {}) {
    const config = { ...defaultProductionConfig, ...options };
    const buildConfig = {
 ...
 */
export function generatePreloadHints(chunks) {
    return chunks
 ...
 */
export function generatePrefetchHints(chunks) {
    return chunks
 ...
 */
export function checkPerformanceBudgets(stats, budgets = {}) {
