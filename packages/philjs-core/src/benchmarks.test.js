...
describe('Performance Benchmarks', () => {
    ...
    describe('Computed (Memo) Performance', () => {
        ...
        it('should handle diamond dependency graph efficiently', () => {
            ...
            const layer2 = Array.from({ length: branches }, (_, i) => memo(() => layer1[i]() + 1));
            const combined = memo(() => layer2.reduce((sum, m) => sum + m(), 0));
            const start = performance.now();
            ...
            const Dashboard = () => jsx('div', {
                ...
                children: [
                    ...
                    jsx('table', { children: [
                            ...
                            jsx('tbody', { children: data.map(user => jsx('tr', { key: user.id, children: [
    ...
    describe('Real-World Scenarios', () => {
        ...
        it('Form validation - 100 fields with complex validation', () => {
            ...
            const validMemos = valueSignals.map(valueSig => memo(() => {
                const val = valueSig();
