...
describe("Context API - Basic Usage", () => {
  ...
  it("should provide value to consumers", () => {
    ...
    Provider({ value: "provided", children: null as any });
...
describe("Context API - Nested Contexts", () => {
  it("should handle nested providers", () => {
    ...
    // Outer provider
    TestContext.Provider({ value: "outer", children: null as any });

    const outerValue = useContext(TestContext);
    expect(outerValue).toBe("outer");

    // Inner provider
    TestContext.Provider({ value: "inner", children: null as any });
  ...
  it("should handle deeply nested contexts", () => {
    ...
    TestContext.Provider({ value: 1, children: null as any });
    expect(useContext(TestContext)).toBe(1);

    TestContext.Provider({ value: 2, children: null as any });
    expect(useContext(TestContext)).toBe(2);

    TestContext.Provider({ value: 3, children: null as any });
  ...
  it("should handle different contexts independently", () => {
    ...
    Context1.Provider({ value: "value1", children: null as any });
    Context2.Provider({ value: "value2", children: null as any });
  ...
  it("should isolate nested context scopes", () => {
    ...
    TestContext.Provider({ value: "level1", children: null as any });
    const level1 = useContext(TestContext);

    TestContext.Provider({ value: "level2", children: null as any });
...
describe("Context API - Multiple Consumers", () => {
  it("should allow multiple consumers of same context", () => {
    ...
    TestContext.Provider({ value: { count: 5 }, children: null as any });
  ...
  it("should handle Consumer component render prop", () => {
    ...
    TestContext.Provider({ value: "test value", children: null as any });
...
describe("Context API - Signal Context", () => {
  ...
  it("should read signal context value", () => {
    ...
    SignalContext.Provider({ value: { get: () => 100, set: () => {}, subscribe: () => () => {} }, children: null as any });
...
describe("Context API - Combine Providers", () => {
  it("should combine multiple providers", () => {
    ...
    const CombinedProvider = combineProviders(
      { Provider: Context1.Provider, value: "combined1" },
      { Provider: Context2.Provider, value: "combined2" }
    );

    const result = CombinedProvider({ children: null as any });
  ...
  it("should nest providers in correct order", () => {
    ...
    const CombinedProvider = combineProviders(
      { Provider: Context1.Provider, value: "a" },
      { Provider: Context2.Provider, value: "b" },
      { Provider: Context3.Provider, value: "c" }
    );
...
describe("Context API - Edge Cases", () => {
  ...
  it("should handle object reference equality", () => {
    ...
    TestContext.Provider({ value: obj, children: null as any });
  ...
  it("should handle array values", () => {
    ...
    TestContext.Provider({ value: arr, children: null as any });
  ...
  it("should handle Map and Set values", () => {
    ...
    TestContext.Provider({ value: map, children: null as any });
