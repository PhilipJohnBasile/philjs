...
describe("Error Boundary - Fallback UI", () => {
  it("should use custom fallback UI", () => {
    const customFallback = (error: ErrorInfo, retry: () => void) => ({
      type: "div",
      props: {
...
describe("Error Suggestions", () => {
  it("should suggest optional chaining for undefined errors", () => {
    ...
    const boundary = ErrorBoundary({
      children: { type: "div", props: {} },
      onError: (errorInfo) => {
        const optionalChainingSuggestion = errorInfo.suggestions.find((s) =>
  ...
  it("should suggest null check for undefined errors", () => {
    ...
    const boundary = ErrorBoundary({
      children: { type: "div", props: {} },
      onError: (errorInfo) => {
        const nullCheckSuggestion = errorInfo.suggestions.find((s) =>
          s.description.includes("null check")
        );
