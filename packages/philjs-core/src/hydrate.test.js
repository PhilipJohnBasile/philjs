...
describe("render() dynamic accessors", () => {
    it("updates text content when a signal changes", () => {
        ...
        render(_jsx("div", { "data-testid": "counter", children: count }), container);
    ...
    it("swaps conditional children without leaving stale nodes", () => {
        ...
        const container = createContainer();
        render(_jsx("div", { "data-testid": "conditional", children: () => toggle()
                ? [_jsx("span", { "data-marker": "a", children: "A" }), _jsx("span", { "data-marker": "b", children: "B" })]
                : _jsx("span", { "data-marker": "c", children: "C" }) }), container);
        const getMarkers = () => Array.from(container.querySelectorAll("[data-marker]")).map((el) => el.dataset.marker);
    ...
    it("removes DOM nodes when dynamic accessor returns null", () => {
        ...
        const container = createContainer();
        render(_jsx("div", { "data-testid": "nullable", children: () => (show() ? _jsx("span", { "data-marker": "present", children: "Here" }) : null) }), container);
