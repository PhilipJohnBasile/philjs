...
export interface Theme {
    ...
    getToken: <K extends keyof ThemeTokens>(category: K, key: string) => string | number;
}
/**
 ...
 */
export type AtomicProperty = 'margin' | 'marginTop' | 'marginRight' | 'marginBottom' | 'marginLeft' | 'padding' | 'paddingTop' | 'paddingRight' | 'paddingBottom' | 'paddingLeft' | 'width' | 'height' | 'display' | 'flexDirection' | 'justifyContent' | 'alignItems' | 'gap' | 'color' | 'backgroundColor' | 'fontSize' | 'fontWeight' | 'lineHeight' | 'textAlign' | 'borderRadius' | 'border' | 'borderWidth' | 'position' | 'top' | 'right' | 'bottom' | 'left' | 'zIndex' | 'opacity' | 'transform' | 'transition';
