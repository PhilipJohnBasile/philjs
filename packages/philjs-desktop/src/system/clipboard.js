...
export const Clipboard = {
    ...
    async readText() {
        ...
        try {
            ...
            throw new ClipboardError('Failed to read text from clipboard. Ensure @tauri-apps/plugin-clipboard-manager is installed and configured.', error);
        }
    },
    /**
    ...
    async writeText(text) {
        ...
        try {
            ...
            throw new ClipboardError('Failed to write text to clipboard. Ensure @tauri-apps/plugin-clipboard-manager is installed and configured.', error);
        }
    },
    /**
    ...
    async readHtml() {
        ...
        try {
            ...
            throw new ClipboardError('Failed to read HTML from clipboard. Ensure @tauri-apps/plugin-clipboard-manager is installed and configured.', error);
        }
    },
    /**
    ...
    async writeHtml(html) {
        ...
        try {
            ...
            throw new ClipboardError('Failed to write HTML to clipboard. Ensure @tauri-apps/plugin-clipboard-manager is installed and configured.', error);
        }
    },
    /**
    ...
    async readImage() {
        ...
        try {
            ...
            throw new ClipboardError('Failed to read image from clipboard. Ensure @tauri-apps/plugin-clipboard-manager is installed and configured.', error);
        }
    },
    /**
    ...
    async writeImage(imageData) {
        ...
        try {
            ...
            throw new ClipboardError('Failed to write image to clipboard. Ensure @tauri-apps/plugin-clipboard-manager is installed and configured.', error);
        }
    },
    /**
     * Clear clipboard
    ...
    async clear() {
        ...
        try {
            ...
            throw new ClipboardError('Failed to clear clipboard. Ensure @tauri-apps/plugin-clipboard-manager is installed and configured.', error);
        }
    },
    /**
