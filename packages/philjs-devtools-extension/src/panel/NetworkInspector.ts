...
export class NetworkInspector {
  ...
  private getFilteredRequests(): NetworkRequest[] {
  ...
  private renderRequestList(requests: NetworkRequest[]): string {
  ...
  private renderRequestRow(request: NetworkRequest): string {
  ...
  private renderRequestDetails(request: NetworkRequest): string {
    return `
  ...
  private renderHeaders(request: NetworkRequest): string {
