...
export class PerformancePanel {
    ...
    recordRender(componentId, profile) {
        if (!this.isRecording)
            return;
...
//# sourceMappingURL=performance-panel.js.map