...
export class StylePanel {
  ...
  private renderBoxModel(element: HTMLElement, styles: CSSStyleDeclaration): string {
    const margin = {
  ...
  private renderInlineStyles(styles: CSSStyleDeclaration): string {
  ...
  private renderComputedStyles(styles: CSSStyleDeclaration): string {
  ...
  public getComputedBox(element: HTMLElement): ComputedBox {
