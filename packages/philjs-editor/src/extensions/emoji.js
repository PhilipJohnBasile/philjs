 ...
 */
function createEmojiPlugin(emojis) {
 ...
 */
export function getEmoji(shortcode, customEmojis) {
 ...
 */
export function searchEmojis(query, customEmojis, limit = 20) {
    const emojis = { ...commonEmojis, ...customEmojis };
    const results = [];
 ...
 */
export function replaceShortcodes(text, customEmojis) {
    const emojis = { ...commonEmojis, ...customEmojis };
 ...
 */
export function emojiToShortcode(text, customEmojis) {
    const emojis = { ...commonEmojis, ...customEmojis };
