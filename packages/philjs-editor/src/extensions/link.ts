 ...
 * Validate URL format
 */
export function isValidUrl(url: string, protocols = ['http', 'https', 'mailto', 'tel']): boolean {
  if (!url) return false;
 ...
 */
function showPreview(element: HTMLElement, preview: LinkPreviewData) {
 ...
 */
export function getLinkAtSelection(editor: any): string | null {
