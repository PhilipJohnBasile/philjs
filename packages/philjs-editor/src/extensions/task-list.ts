 ...
 */
export function createTaskListExtensions(options: TaskListOptions = {}) {
 ...
 */
export function getTaskStats(editor: any): {
  total: number;
  completed: number;
  pending: number;
  percentage: number;
 ...
 */
export function getAllTasks(editor: any): Array<{
  text: string;
  checked: boolean;
  position: number;
}> {
 ...
 */
export function toggleTaskAtPosition(editor: any, position: number) {
 ...
 * Check all tasks
 */
export function checkAllTasks(editor: any) {
  const { tr } = editor.state;
  let modified = false;
 ...
 * Uncheck all tasks
 */
export function uncheckAllTasks(editor: any) {
  const { tr } = editor.state;
  let modified = false;
 ...
 */
export function bulletListToTaskList(editor: any) {
 ...
 */
export function taskListToBulletList(editor: any) {
