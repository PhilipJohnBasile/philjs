 ...
 */
export function throwInvalidRoutePattern(pattern, reason) {
 ...
 */
export function ensureValidRoutePattern(pattern) {
 ...
 */
export function getRequiredParams(pattern) {
    const validation = validateRoutePattern(pattern);
 ...
 */
export function validateNavigationParams(pattern, providedParams) {
    const validation = validateRoutePattern(pattern);
 ...
 */
export function throwMissingRouteParameter(pattern, paramName) {
 ...
 */
export function registerRoute(pattern) {
 ...
 */
export function unregisterRoute(pattern) {
 ...
 */
export function warnRouteNotFound(path) {
 ...
 */
export function recordNavigation(from, to, success, error) {
    const event = {
        from,
        to,
        timestamp: Date.now(),
 ...
 */
export function clearRouterErrorTracking() {
 ...
 */
export function suggestSimilarRoutes(path, maxSuggestions = 3) {
