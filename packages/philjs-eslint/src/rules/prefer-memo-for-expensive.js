...
export default createRule({
    ...
    create(context) {
        ...
        function getExpensiveReason(node) {
        ...
        function isAlreadyMemoized(node) {
...
//# sourceMappingURL=prefer-memo-for-expensive.js.map