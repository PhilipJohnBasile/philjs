 ...
 */
function createElementRenderer(tagName) {
    return (component, context) => {
        ...
        if (component.a11y) {
            if (component.a11y.role)
                element.setAttribute('role', component.a11y.role);
            if (component.a11y.label)
                element.setAttribute('aria-label', component.a11y.label);
            ...
            if (component.a11y.live)
                element.setAttribute('aria-live', component.a11y.live);
            if (component.a11y.tabIndex !== undefined)
                element.tabIndex = component.a11y.tabIndex;
            if (component.a11y.hidden)
...
export const layoutComponents = [
    ...
    },
    {
        ...
        renderer: (component, context) => {
            ...
            element.style.flexDirection = component.props.direction || 'column';
            if (component.props.gap)
                element.style.gap = component.props.gap;
            if (component.props.align)
                element.style.alignItems = component.props.align;
            if (component.props.justify) {
                const justify = component.props.justify;
    ...
    },
    {
        ...
        renderer: (component, context) => {
            ...
            if (component.props.columns)
                element.style.gridTemplateColumns = component.props.columns;
            if (component.props.rows)
                element.style.gridTemplateRows = component.props.rows;
            if (component.props.gap)
                element.style.gap = component.props.gap;
            if (component.className)
                element.className = component.className;
...
export const textComponents = [
    {
        ...
        renderer: (component, context) => {
            ...
            if (component.props.size)
                element.dataset.size = component.props.size;
            if (component.props.weight)
                element.style.fontWeight = component.props.weight;
    ...
    },
    {
        ...
        renderer: (component) => {
            const level = Math.min(6, Math.max(1, component.props.level || 2));
...
export const inputComponents = [
    {
        ...
        renderer: (component, context) => {
            ...
            element.id = component.id;
            element.textContent = component.props.children;
            element.type = component.props.type || 'button';
            element.disabled = !!(component.props.disabled || component.props.loading);
            element.dataset.variant = component.props.variant || 'primary';
            element.dataset.size = component.props.size || 'md';
            if (component.className)
                element.className = component.className;
            // Handle click events
    ...
    },
    {
        ...
        renderer: (component, context) => {
            ...
            if (component.props.name)
                element.name = component.props.name;
            if (component.className)
                element.className = component.className;
...
export const feedbackComponents = [
    {
        ...
        renderer: (component, context) => {
            ...
            element.dataset.variant = component.props.variant || 'info';
            element.textContent = component.props.children;
            if (component.className)
                element.className = component.className;
    ...
    },
    {
        ...
        renderer: (component) => {
            ...
            element.setAttribute('aria-label', component.props.label || 'Loading');
            element.dataset.size = component.props.size || 'md';
...
//# sourceMappingURL=builtin-components.js.map