...
import { initGoProject, buildGoServer, createGoServer, checkGoInstalled, } from './server.js';
...
async function handleInit(values, positionals) {
    const dir = positionals[1] || '.';
    const module = values['module'] || `github.com/user/${resolve(dir).split(/[/\\]/).pop()}`;
