 ...
 */
export async function createGoServer(config: GoServerConfig): Promise<GoServer> {
 ...
 */
export async function buildGoServer(options: GoBuildOptions = {}): Promise<string> {
  const {
    outDir = './dist/go',
 ...
 */
export async function initGoProject(
  dir: string,
