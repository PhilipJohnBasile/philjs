 ...
 */
export declare function createGraphQLLoader<TData = any, TVariables = any>(client: GraphQLClient, query: string | DocumentNode): any;
/**
 * Create a GraphQL action for mutations
 */
export declare function createGraphQLAction<TData = any, TVariables = any>(client: GraphQLClient, mutation: string | DocumentNode): any;
/**
 * GraphQL utilities
 */
export declare const gql: (strings: TemplateStringsArray, ...values: any[]) => string;
export type { DocumentNode };
export { SubscriptionClient, SubscriptionHandle, createSubscriptionClient, useSubscription, type SubscriptionConfig, type SubscriptionOptions, type SubscriptionState, } from './subscription.js';
export { PersistedQueryManager, PersistedQueryRegistry, createPersistedQueryManager, createPersistedQueryRegistry, shouldRetryWithFullQuery, buildPersistedQueryRequest, extractQueryHash, generatePersistedQueryManifest, type PersistedQueryConfig, type PersistedQueryLink, } from './persisted.js';
export { FragmentRegistry, defineFragment, maskFragment, unmaskFragment, isMaskedFragment, spreadFragment, composeFragments, buildQueryWithFragments, useFragment, withFragment, getComponentFragment, mergeFragmentData, selectFromFragment, getFragmentRegistry, createFragmentRegistry, fragment, inlineFragment, FragmentUtils, type FragmentDefinition, type MaskedFragment, } from './fragments.js';
export { OptimisticUpdateManager, OptimisticResponseBuilder, MutationQueue, LastWriteWinsResolver, FirstWriteWinsResolver, CustomConflictResolver, createOptimisticUpdateManager, buildOptimisticResponse, createMutationQueue, type OptimisticUpdateConfig, type OptimisticMutation, type OptimisticUpdateSnapshot, type ConflictResolver, } from './optimistic.js';
export { GraphQLCodegen, BatchCodegen, createCodegen, createBatchCodegen, runCodegen, extractOperationInfo, extractFragmentInfo, type CodegenConfig, type GeneratedOperation, type GeneratedFragment, } from './codegen-enhanced.js';
