 ...
 */
export function createVueWrapper(tagName, props, emits = []) {
            ...
            return () => {
                ...
                return {
                    ...
                    props: {
                        ...elementProps,
                        // Event handlers
                        ...Object.fromEntries(emits.map((eventName) => [
                            `on${eventName.charAt(0).toUpperCase()}${eventName.slice(1)}`,
                            (event) => emit(eventName, event.detail),
                        ])),
                    },
 ...
 */
export const HollowButton = createVueWrapper('hollow-button', [
 ...
 * Vue Input component
 */
export const HollowInput = createVueWrapper('hollow-input', [
 ...
 * Vue Card component
 */
export const HollowCard = createVueWrapper('hollow-card', [
    { name: 'variant', type: 'String', default: 'default' },
 ...
 * Vue Modal component
 */
export const HollowModal = createVueWrapper('hollow-modal', [
 ...
 */
export const HollowSelect = createVueWrapper('hollow-select', [
    { name: 'variant', type: 'String', default: 'default' },
    { name: 'size', type: 'String', default: 'md' },
    { name: 'value', type: 'String', default: '' },
 ...
 */
export const HollowCheckbox = createVueWrapper('hollow-checkbox', [
    { name: 'variant', type: 'String', default: 'primary' },
    { name: 'size', type: 'String', default: 'md' },
 ...
 */
export const HollowSwitch = createVueWrapper('hollow-switch', [
    { name: 'variant', type: 'String', default: 'primary' },
    { name: 'size', type: 'String', default: 'md' },
    { name: 'checked', type: 'Boolean', default: false },
    { name: 'disabled', type: 'Boolean', default: false },
 ...
 * Vue Tabs component
 */
export const HollowTabs = createVueWrapper('hollow-tabs', [
    { name: 'variant', type: 'String', default: 'default' },
    { name: 'size', type: 'String', default: 'md' },
 ...
 */
export const HollowAccordion = createVueWrapper('hollow-accordion', [
    { name: 'variant', type: 'String', default: 'default' },
    { name: 'multiple', type: 'Boolean', default: false },
 ...
 */
export const HollowAccordionItem = createVueWrapper('hollow-accordion-item', [
