 ...
 */
export function createI18n<T extends TranslationMap>(options: I18nOptions<T>): I18n<T> {
...
): (locale: string, n: number, forms: string[]) => string {
  return (locale: string, n: number, forms: string[]): string => {
