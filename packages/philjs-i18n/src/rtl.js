 ...
 */
export function setElementDirection(element, locale) {
    element.dir = getTextDirection(locale);
}
/**
 * Get direction-specific value
 */
export function getDirectionalValue(values, locale) {
 ...
 */
export const physicalToLogical = {
    // Margin
 ...
 */
export function flipValue(property, value) {
 ...
 */
export function wrapInIsolate(text, direction = 'auto') {
    const start = direction === 'ltr'
        ? BIDI_CHARS.LRI
        : direction === 'rtl'
            ? BIDI_CHARS.RLI
            : BIDI_CHARS.FSI;
 ...
 */
export function addDirectionalMark(text, direction) {
 ...
 */
export function stripBidiChars(text) {
    const bidiPattern = /[\u200E\u200F\u202A-\u202E\u2066-\u2069]/g;
 ...
 */
export function mirrorBrackets(text) {
    return text
        .split('')
 ...
 */
export function createRtlConfig(locale) {
 ...
 */
export function getStartEnd(isRtl) {
    return isRtl
 ...
 */
export function logicalToPhysical(logical, isRtl) {
    if (logical === 'start') {
