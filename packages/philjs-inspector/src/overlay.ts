...
let hoverHighlightBox: HTMLElement | null = null;
let componentLabel: HTMLElement | null = null;
 ...
 */
export function highlightElementHover(
  element: Element,
...
export function updateHighlightPosition(): void {
  if (!currentHighlightedElement || !highlightBox) return;
 ...
 */
export function flashHighlight(element: Element, color: string = '#10b981'): void {
  if (!overlayRoot) return;
 ...
 */
export function showElementMeasurements(element: Element): HTMLElement {
