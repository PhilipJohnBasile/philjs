 ...
 */
export function livePatch(to: string, options?: { replace?: boolean }): void {
 ...
 */
export function liveRedirect(to: string, options?: { replace?: boolean }): void {
  const event: NavigationEvent = {
    type: 'redirect',
    to,
    replace: options?.replace ?? false,
 ...
 */
export function onNavigate(callback: (event: NavigationEvent) => void): () => void {
...
function notifyListeners(event: NavigationEvent): void {
 ...
 */
export function getNavigation(): LiveNavigation {
  return {
 ...
 */
export function parseUrl(url: string): { path: string; params: URLSearchParams; hash: string } {
 ...
 */
export function updateParams(params: Record<string, string | undefined>): string {
 ...
 */
export function saveScrollPosition(key: string = navigationState.currentPath): void {
  if (typeof window === 'undefined') return;
 ...
 */
export function restoreScrollPosition(key: string = navigationState.currentPath): void {
  if (typeof window === 'undefined') return;
 ...
 */
export function scrollToTarget(hash?: string): void {
  if (typeof window === 'undefined') return;
 ...
 * Update page title
 */
export function setPageTitle(title: string, prefix?: string, suffix?: string): void {
 ...
 * Set loading state
 */
export function setLoading(loading: boolean, target?: string): void {
 ...
 */
export function onLoading(callback: (loading: boolean) => void): () => void {
