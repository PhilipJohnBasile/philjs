...
export function OpenGraph(props) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Meta, { property: "og:type", content: type }), title && _jsx(Meta, { property: "og:title", content: title }), description && _jsx(Meta, { property: "og:description", content: description }), url && _jsx(Meta, { property: "og:url", content: url }), siteName && _jsx(Meta, { property: "og:site_name", content: siteName }), locale && _jsx(Meta, { property: "og:locale", content: locale }), alternateLocales?.map((loc, i) => (_jsx(Meta, { property: "og:locale:alternate", content: loc }, `locale-${i}`))), allImages.map((img, i) => (_jsxs("span", { children: [_jsx(Meta, { property: "og:image", content: img.url }), img.width && _jsx(Meta, { property: "og:image:width", content: String(img.width) }), img.height && _jsx(Meta, { property: "og:image:height", content: String(img.height) }), img.alt && _jsx(Meta, { property: "og:image:alt", content: img.alt }), img.type && _jsx(Meta, { property: "og:image:type", content: img.type }), img.secureUrl && _jsx(Meta, { property: "og:image:secure_url", content: img.secureUrl })] }, i))), article && (_jsxs(_Fragment, { children: [article.publishedTime && _jsx(Meta, { property: "article:published_time", content: article.publishedTime }), article.modifiedTime && _jsx(Meta, { property: "article:modified_time", content: article.modifiedTime }), article.author && _jsx(Meta, { property: "article:author", content: article.author }), article.section && _jsx(Meta, { property: "article:section", content: article.section }), article.tags?.map((tag, i) => (_jsx(Meta, { property: "article:tag", content: tag }, `tag-${i}`)))] })), profile && (_jsxs(_Fragment, { children: [profile.firstName && _jsx(Meta, { property: "profile:first_name", content: profile.firstName }), profile.lastName && _jsx(Meta, { property: "profile:last_name", content: profile.lastName }), profile.username && _jsx(Meta, { property: "profile:username", content: profile.username }), profile.gender && _jsx(Meta, { property: "profile:gender", content: profile.gender })] }))] }));
}
/**
...
export function AlternateLanguages(props) {
    return (_jsxs(_Fragment, { children: [props.languages.map((lang, i) => (_jsx(Link, { rel: "alternate", href: lang.url, hrefLang: lang.lang }, `lang-${i}`))), props.default && (_jsx(Link, { rel: "alternate", href: props.default, hrefLang: "x-default" }))] }));
}
/**
 * Preconnect Links
 */
