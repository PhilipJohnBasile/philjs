...
export async function migrate(options) {
    const { source, target = source, framework, dryRun = false, verbose = false, include = ['**/*.{js,jsx,ts,tsx,vue,svelte}'], exclude = ['**/node_modules/**', '**/dist/**', '**/build/**'], generateReport: shouldGenerateReport = true, } = options;
...
function getTransform(framework) {
    switch (framework) {
        case 'react':
...
async function findFiles(source, include, exclude) {
    const files = [];
