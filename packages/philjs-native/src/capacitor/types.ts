...
export interface AppPlugin {
  ...
  addListener: (
    eventName: 'appStateChange' | 'appUrlOpen' | 'appRestoredResult' | 'backButton' | 'pause' | 'resume',
...
export interface CameraPlugin {
  ...
  pickImages: (options: { quality?: number; limit?: number }) => Promise<GalleryPhotos>;
  pickLimitedLibraryPhotos: () => Promise<GalleryPhotos>;
  getLimitedLibraryPhotos: () => Promise<GalleryPhotos>;
  checkPermissions: () => Promise<PermissionStatus>;
  requestPermissions: (permissions?: { permissions: Array<'camera' | 'photos'> }) => Promise<PermissionStatus>;
}
...
export interface GeolocationPlugin {
  ...
  clearWatch: (options: { id: WatchCallbackId }) => Promise<void>;
  checkPermissions: () => Promise<{ location: 'prompt' | 'granted' | 'denied'; coarseLocation: 'prompt' | 'granted' | 'denied' }>;
  requestPermissions: (permissions?: { permissions: Array<'location' | 'coarseLocation'> }) => Promise<{ location: 'prompt' | 'granted' | 'denied'; coarseLocation: 'prompt' | 'granted' | 'denied' }>;
}
...
export interface FilesystemPlugin {
  ...
  getUri: (options: { path: string; directory: FilesystemDirectory }) => Promise<{ uri: string }>;
  rename: (options: RenameOptions) => Promise<void>;
  copy: (options: CopyOptions) => Promise<CopyResult>;
  checkPermissions: () => Promise<{ publicStorage: 'prompt' | 'granted' | 'denied' }>;
  requestPermissions: () => Promise<{ publicStorage: 'prompt' | 'granted' | 'denied' }>;
}
...
export interface LocalNotificationsPlugin {
  ...
  pending: () => Promise<{ notifications: { id: number }[] }>;
  cancel: (options: { notifications: { id: number }[] }) => Promise<void>;
  registerActionTypes: (options: { types: { id: string; actions: { id: string; title: string }[] }[] }) => Promise<void>;
  areEnabled: () => Promise<{ value: boolean }>;
  getDeliveredNotifications: () => Promise<{ notifications: { id: number; title: string; body: string }[] }>;
  removeDeliveredNotifications: (options: { notifications: { id: number }[] }) => Promise<void>;
  removeAllDeliveredNotifications: () => Promise<void>;
  createChannel: (options: { id: string; name: string; importance?: number; description?: string }) => Promise<void>;
  deleteChannel: (options: { id: string }) => Promise<void>;
  listChannels: () => Promise<{ channels: { id: string; name: string }[] }>;
  checkPermissions: () => Promise<{ display: 'prompt' | 'granted' | 'denied' }>;
  requestPermissions: () => Promise<{ display: 'prompt' | 'granted' | 'denied' }>;
  addListener: (
...
export interface PushNotificationsPlugin {
  ...
  getDeliveredNotifications: () => Promise<{ notifications: { id: string; data: Record<string, unknown> }[] }>;
  removeDeliveredNotifications: (options: { notifications: { id: string }[] }) => Promise<void>;
  removeAllDeliveredNotifications: () => Promise<void>;
  createChannel: (options: { id: string; name: string; importance?: number; description?: string }) => Promise<void>;
  deleteChannel: (options: { id: string }) => Promise<void>;
  listChannels: () => Promise<{ channels: { id: string; name: string }[] }>;
...
export interface StatusBarPlugin {
  ...
  show: (options?: { animation?: StatusBarAnimation }) => Promise<void>;
  hide: (options?: { animation?: StatusBarAnimation }) => Promise<void>;
...
export interface KeyboardPlugin {
  ...
  getResizeMode: () => Promise<{ mode: KeyboardResize }>;
  addListener: (
...
export interface StoragePlugin {
  get: (options: { key: string }) => Promise<StorageGetResult>;
 ...
 */
export function isCapacitorGlobal(value: unknown): value is CapacitorGlobal {
  return (
    typeof value === 'object' &&
    value !== null &&
    'getPlatform' in value &&
    typeof (value as CapacitorGlobal).getPlatform === 'function'
  );
}
