 ...
 */
function getPrefersCrossFade(): boolean {
  if (typeof window === 'undefined') return false;
  // This is an iOS-specific preference
  return (globalThis as any).__PHILJS_PREFERS_CROSS_FADE__ === true;
}

/**
 * Get all appearance preferences
 */
function getAppearancePreferences(): AppearancePreferences {
 ...
 */
const colorSchemeSignal: Signal<ColorScheme> = signal(getInitialColorScheme());

/**
 * Appearance preferences signal
 */
const appearanceSignal: Signal<AppearancePreferences> = signal(
 ...
 */
let userColorSchemeOverride: ColorScheme | null = null;

/**
 * Change subscribers
 */
const subscribers = new Set<AppearanceChangeHandler>();
 ...
 */
export const colorScheme: Signal<ColorScheme> = colorSchemeSignal;

/**
 * Reactive dark mode signal
 */
export const isDarkMode: Signal<boolean> = signal(
  colorSchemeSignal() === 'dark'
);
 ...
 */
export const reducedMotion: Signal<boolean> = signal(getReduceMotion());
 ...
 */
export const highContrast: Signal<boolean> = signal(getHighContrast());
 ...
 */
export function colorForScheme<T>(lightValue: T, darkValue: T): T {
