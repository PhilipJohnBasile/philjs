...
export interface TauriEventModule {
    listen: <T = unknown>(event: string, handler: TauriEventHandler<T>) => Promise<TauriUnlistenFn>;
    once: <T = unknown>(event: string, handler: TauriEventHandler<T>) => Promise<TauriUnlistenFn>;
 ...
 * Base directories
 */
export type TauriBaseDirectory = 'App' | 'AppConfig' | 'AppData' | 'AppLocalData' | 'AppCache' | 'AppLog' | 'Audio' | 'Cache' | 'Config' | 'Data' | 'Desktop' | 'Document' | 'Download' | 'Executable' | 'Font' | 'Home' | 'LocalData' | 'Log' | 'Picture' | 'Public' | 'Resource' | 'Runtime' | 'Temp' | 'Template' | 'Video';
/**
...
export interface TauriFsModule {
    ...
    readDir: (path: string, options?: TauriFsOptions & {
        recursive?: boolean;
    }) => Promise<TauriFileEntry[]>;
    createDir: (path: string, options?: TauriFsOptions & {
        recursive?: boolean;
    }) => Promise<void>;
    removeDir: (path: string, options?: TauriFsOptions & {
        recursive?: boolean;
    }) => Promise<void>;
 ...
 */
export declare function isTauriInternals(value: unknown): value is TauriInternals;
/**
 * Check if value is TauriWebviewWindow
 */
export declare function isTauriWebviewWindow(value: unknown): value is TauriWebviewWindow;
/**
