...
import { isTauri, getTauriInternals, getCurrentWindow, createWindow, getAllWindows, } from './index.js';
 ...
 */
export const windowState = signal({
    label: 'main',
    title: '',
    position: { x: 0, y: 0 },
 ...
 * All windows state
 */
export const allWindows = signal(new Map());
/**
 * Current theme
 */
export const currentTheme = signal('system');
/**
 * Primary monitor
 */
export const primaryMonitor = signal(null);
/**
 * All monitors
 */
export const allMonitors = signal([]);
// ============================================================================
// Window Manager
// ============================================================================
/**
 ...
 * Create a new window
 */
export async function openWindow(label, options) {
...
export async function getWindows() {
    ...
    return windows.map((win) => new WindowManager(win.label));
}
/**
 * Get window by label
 */
export function getWindowByLabel(label) {
    if (!isTauri())
        return null;
    const internals = getTauriInternals();
 ...
 */
export function useWindow(label) {
...
export async function initWindowState() {
    ...
    subscribe('tauri://resize', (size) => {
        windowState.set({ ...windowState(), size });
    });
    subscribe('tauri://move', (position) => {
