...
function getColorForValue(value: number, thresholds?: { value: number; color: string }[], defaultColor?: string): string {
 ...
 */
export function GaugeChart(props: GaugeChartProps): string {
  const {
    value,
    min = 0,
    max = 100,
 ...
 */
export function MiniGauge(props: MiniGaugeProps): string {
  const {
    value,
    max = 100,
    size = 40,
 ...
 */
export function HalfGauge(props: HalfGaugeProps): string {
  const {
    value,
    min = 0,
    max = 100,
