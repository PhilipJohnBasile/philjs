    ...
    loadScript() {
        ...
        (function (c, a) {
            if (!a.__SV) {
                let b = window;
                try {
                    let d, m, j, k = b.location, f = k.hash;
                    d = function (a, b) {
                ...
                a.init = function (b, d, g) {
                    ...
                    for (h = 0; h < l.length; h++)
                        c(e, l[h]);
                    let f = "set set_once union unset remove delete".split(" ");
                    e.get_group = function () {
                        ...
                        for (let b = {}, d = ["get_group"].concat(Array.prototype.slice.call(arguments, 0)), c = 0; c < f.length; c++)
                            a(f[c]);
                        return b;
                    };
                    a._i.push([b, d, g]);
