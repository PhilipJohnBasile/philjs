...
export function generateServiceWorker(config = {}) {
    const { cachePrefix = 'philjs', cacheVersion = 'v1', precache = [], runtimeCaching = [], skipWaiting = true, clientsClaim = true, navigationPreload = true, offlineFallback, backgroundSync, } = config;
 ...
 */
export async function registerServiceWorker(scriptURL = '/sw.js', options) {
