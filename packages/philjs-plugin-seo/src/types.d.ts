 ...
 */
export type JsonLdType = 'Organization' | 'Person' | 'WebSite' | 'WebPage' | 'Article' | 'NewsArticle' | 'BlogPosting' | 'Product' | 'BreadcrumbList' | 'FAQPage' | 'HowTo' | 'Recipe' | 'Event' | 'LocalBusiness' | 'Review' | 'VideoObject' | 'ImageObject' | 'SoftwareApplication' | 'Course' | 'JobPosting';
/**
 ...
 * All JSON-LD types
 */
export type JsonLd = OrganizationJsonLd | WebSiteJsonLd | ArticleJsonLd | ProductJsonLd | BreadcrumbJsonLd | FAQJsonLd | (JsonLdBase & Record<string, unknown>);
/**
 * Sitemap entry
 */
