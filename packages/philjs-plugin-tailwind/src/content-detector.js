 ...
 */
export async function detectContentPaths(rootDir, options) {
 ...
 */
export function validateContentPatterns(patterns) {
    const valid = [];
    const invalid = [];
 ...
 */
export function expandContentPatterns(patterns) {
 ...
 */
export function optimizeContentPatterns(patterns) {
    const optimized = [];
    const seen = new Set();
    for (const pattern of patterns) {
        // Normalize pattern
