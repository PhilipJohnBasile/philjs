 ...
 */
export function generateTypographyScale(baseSize = 16, ratio = 1.25) {
    const scale = {};
 ...
 */
export function generateBreakpoints(type = "mobile-first") {
...
export function generateCompleteTheme(options) {
    ...
    if (options?.brandColors) {
        ...
        if (brandTheme.colors !== undefined)
            theme.colors = brandTheme.colors;
    }
    // Add typography
    if (options?.typography) {
        const fontSize = generateTypographyScale(options.typography.baseSize, options.typography.ratio);
 ...
 */
export function cssVarsToTheme(cssVars) {
    const theme = {
        extend: {},
    };
...
//# sourceMappingURL=theme-generator.js.map