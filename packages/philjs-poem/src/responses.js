...
export class FileResponse {
    ...
    data;
    inline;
    constructor(filename, data, contentType, inline = false) {
 ...
 */
export function redirect(url, permanent = false) {
 ...
 */
export function file(filename, data, contentType) {
