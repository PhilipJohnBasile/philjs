 ...
 * Create a cookie jar
 */
export function createCookieJar(cookieHeader) {
    return new CookieJarImpl(cookieHeader);
}
/**
 * Cookie jar implementation
 */
export class CookieJarImpl {
    cookies = new Map();
    privateCookies = new Map();
    setCookies = [];
    secretKey;
    constructor(cookieHeader, secretKey) {
 ...
 */
export function persistentCookie(name, value, maxAgeDays, options) {
    return {
        name,
        value,
        options: {
 ...
 */
export function removalCookie(name, options) {
    return {
        name,
        value: '',
        options: {
 ...
 * Set a flash message
 */
export function setFlash(jar, kind, message) {
 ...
 */
export function flashSuccess(jar, message) {
    setFlash(jar, 'success', message);
}
/**
 * Set an error flash message
 */
export function flashError(jar, message) {
    setFlash(jar, 'error', message);
}
/**
 * Set an info flash message
 */
export function flashInfo(jar, message) {
    setFlash(jar, 'info', message);
}
/**
 * Set a warning flash message
 */
export function flashWarning(jar, message) {
 ...
 */
export function generateRustCookieCode() {
    return `
