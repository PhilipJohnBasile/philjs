 ...
 */
export type ExtractPathParams<Path extends string> = Path extends `${string}$${infer Param}/${infer Rest}` ? Param | ExtractPathParams<`/${Rest}`> : Path extends `${string}$${infer Param}` ? Param : never;
/**
 * Convert extracted parameter names to a params object type.
 * e.g., 'userId' | 'postId' -> { userId: string; postId: string }
 */
export type PathParams<Path extends string> = [ExtractPathParams<Path>] extends [never] ? Record<string, unknown> : {
 ...
 */
export type LoaderContext<TPath extends string, TSearchSchema extends z.ZodType | undefined = undefined> = {
 ...
 */
export type LoaderFn<TPath extends string, TSearchSchema extends z.ZodType | undefined = undefined, TLoaderData = unknown> = (context: LoaderContext<TPath, TSearchSchema>) => Promise<TLoaderData> | TLoaderData;
/**
 * Infer loader data type from a route definition
 */
export type InferLoaderData<T> = T extends RouteDefinition<infer _Path, infer _Search, infer LoaderData> ? LoaderData : never;
/**
 * Options for creating a route
 */
export type RouteOptions<TPath extends string, TSearchSchema extends z.ZodType | undefined = undefined, TLoaderData = unknown> = {
    path: TPath;
 ...
 */
export type BeforeLoadContext<TPath extends string, TSearchSchema extends z.ZodType | undefined = undefined> = {
    params: PathParams<TPath>;
    search: TSearchSchema extends z.ZodType ? z.infer<TSearchSchema> : Record<string, unknown>;
    location: Location;
    cause: "enter" | "stay";
 ...
 */
export type RouteDefinition<TPath extends string = string, TSearchSchema extends z.ZodType | undefined = undefined, TLoaderData = unknown> = {
    readonly id: string;
    readonly path: TPath;
 ...
 */
export type RouteComponentProps<TPath extends string, TSearchSchema extends z.ZodType | undefined = undefined, TLoaderData = unknown> = {
    params: PathParams<TPath>;
    search: TSearchSchema extends z.ZodType ? z.infer<TSearchSchema> : Record<string, unknown>;
 ...
 */
export type RouteComponent<TPath extends string, TSearchSchema extends z.ZodType | undefined = undefined, TLoaderData = unknown> = (props: RouteComponentProps<TPath, TSearchSchema, TLoaderData>) => VNode | JSXElement | string | null;
/**
 ...
 */
export type TypedNavigateOptions<TPath extends string, TSearchSchema extends z.ZodType | undefined = undefined> = NavigateOptions & {
 ...
 */
export type LinkPropsWithRoute<TPath extends string, TSearchSchema extends z.ZodType | undefined = undefined> = {
 ...
 */
export type LinkProps<TPath extends string = string, TSearchSchema extends z.ZodType | undefined = undefined> = LinkPropsWithRoute<TPath, TSearchSchema> | LinkPropsWithPath;
/**
 ...
 */
export type MatchedRoute<TPath extends string = string, TSearchSchema extends z.ZodType | undefined = undefined, TLoaderData = unknown> = {
 ...
 */
export type ExtractRoute<T> = T extends RouteDefinition<infer Path, infer Search, infer LoaderData> ? {
    path: Path;
    search: Search;
 ...
 */
export type AllRoutePaths = keyof RegisteredRoutes extends never ? string : keyof RegisteredRoutes;
