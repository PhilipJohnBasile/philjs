...
import { createAppRouter, useRouter, useRoute, Link, RouterView, createRouteMatcher, } from "./high-level.js";
                ...
                routes: [
                    {
                        ...
                        component: ({ params }) => `${params.lang}/${params.region}/${params.city}`,
                    },
                ],
            });
...
//# sourceMappingURL=router-enhanced.test.js.map