...
import { discoverRoutes, matchRoute, createRoutePattern } from './discovery.js';
import {
...
describe('Smart Preloading', () => {
  describe('calculateClickIntent', () => {
    ...
    it('should return high intent when mouse is moving toward link', () => {
      ...
      const linkBounds = { left: 100, top: 100, width: 20, height: 20 } as DOMRect; // Link to the right and down
    ...
    it('should return low intent when mouse is moving away', () => {
      ...
      const linkBounds = { left: 200, top: 200, width: 20, height: 20 } as DOMRect; // Link to the right and down
    ...
    it('should return low intent when mouse is far from link', () => {
      ...
      const linkBounds = { left: 1000, top: 1000, width: 20, height: 20 } as DOMRect;
    ...
    it('should handle stationary mouse', () => {
      const mousePos = { x: 100, y: 100 };
      const mouseVelocity = { x: 0, y: 0 };
      const linkBounds = { left: 100, top: 100, width: 20, height: 20 } as DOMRect;
    ...
    it('should return value between 0 and 1', () => {
      ...
      const linkBounds = { left: 150, top: 50, width: 20, height: 20 } as DOMRect;
...
describe('Router Integration', () => {
  ...
  it('should handle routes with actions', () => {
    const manifest = {
      '/contact': {
        action: async ({ request }: any) => ({ success: true }),
        default: () => 'Contact'
      }
    };
