 ...
 * ```
 */
export function generatePrefetchServiceWorker(config = {}) {
 ...
 */
export function initServiceWorkerPrefetch() {
 ...
 */
export function requestSwPrefetch(url, priority = 'low') {
    if (!swChannel)
        return;
 ...
 */
export function isSwCached(url) {
    return cachedUrls.has(url);
}
/**
 * Get all cached URLs
 */
export function getSwCachedUrls() {
 ...
 */
export function closeServiceWorkerPrefetch() {
    swChannel?.close();
    swChannel = null;
    cachedUrls.clear();
 ...
 * ```
 */
export async function registerPrefetchServiceWorker(options = {}) {
 ...
 * ```
 */
export function createInlineServiceWorker(config) {
...
//# sourceMappingURL=service-worker-prefetch.js.map