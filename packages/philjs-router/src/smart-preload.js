...
export function calculateClickIntent(mousePos, mouseVelocity, linkBounds) {
    ...
    const distance = Math.hypot(mousePos.x - linkCenter.x, mousePos.y - linkCenter.y);
    ...
    if (velocityMagnitude > 0) {
        ...
        const vectorMagnitude = Math.hypot(vectorToLink.x, vectorToLink.y);
