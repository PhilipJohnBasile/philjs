 ...
 */
export function calculateClickIntent(mousePos, mouseVelocity, linkBounds) {
    // Calculate distance from mouse to link center
    const linkCenter = {
        x: linkBounds.left + linkBounds.width / 2,
        y: linkBounds.top + linkBounds.height / 2,
    };
    const distance = Math.sqrt(Math.pow(mousePos.x - linkCenter.x, 2) + Math.pow(mousePos.y - linkCenter.y, 2));
    ...
    if (velocityMagnitude > 0) {
        ...
        const dotProduct = mouseVelocity.x * vectorToLink.x + mouseVelocity.y * vectorToLink.y;
        const vectorMagnitude = Math.sqrt(vectorToLink.x ** 2 + vectorToLink.y ** 2);
 ...
 */
export function predictNextRoute(currentPath, visitHistory) {
...
export class SmartPreloader {
    constructor(options = {}) {
        ...
        Object.defineProperty(this, "mousePos", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: { x: 0, y: 0 }
        });
        Object.defineProperty(this, "lastMousePos", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: { x: 0, y: 0 }
        });
        Object.defineProperty(this, "mouseVelocity", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: { x: 0, y: 0 }
        });
        Object.defineProperty(this, "visitHistory", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "hoverTimers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
    ...
    registerHoverPreload(element, href) {
    ...
    registerVisibilityPreload(element, href) {
    ...
    calculatePriority(url, options) {
        ...
        const predictions = predictNextRoute(window.location.pathname, this.visitHistory);
    ...
    async fetchRoute(url) {
        ...
        try {
            const response = await fetch(url, {
                ...
                priority: "low", // Use low priority fetch
            });
            if (!response.ok) {
...
export function initSmartPreloader(options) {
    if (globalPreloader) {
...
export function getSmartPreloader() {
    return globalPreloader;
}
// ============================================================================
// React-style Hook
...
// Directive for Links
// ============================================================================
export function preloadLink(element, options = {}) {
    const preloader = getSmartPreloader();
    if (preloader) {
...
//# sourceMappingURL=smart-preload.js.map