 ...
 */
export type EdgeCachingStrategy = "stale-while-revalidate" | "cache-first" | "network-first" | "cache-only";
/**
 ...
 */
export declare const PPR_PLACEHOLDER_START: (id: string) => string;
export declare const PPR_PLACEHOLDER_END: (id: string) => string;
export declare const PPR_FALLBACK_START: (id: string) => string;
export declare const PPR_FALLBACK_END: (id: string) => string;
/**
 * Extract boundary ID from placeholder comment
 */
export declare function extractBoundaryId(comment: string): {
    type: "start" | "end" | "fallback";
    id: string;
} | null;
/**
...
//# sourceMappingURL=ppr-types.d.ts.map