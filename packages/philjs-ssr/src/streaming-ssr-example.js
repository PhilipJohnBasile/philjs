 ...
 */
import { renderToStream, Suspense, Island, registerIsland, hydrateIsland, autoHydrateIslands, HydrationStrategy, webStreamToNodeStream, } from "./index.js";
 ...
 */
export function suspenseBoundaryExample(userId) {
    const App = () => jsx("div", {
        children: [
...
async function ProductList() {
    ...
    return jsx("div", {
        className: "products",
        children: products.map((p) => jsx("div", {
            key: p.id,
...
async function ReviewList() {
    ...
    return jsx("div", {
        className: "reviews",
        children: reviews.map((r) => jsx("div", {
            key: r.id,
...
export function performanceOptimizedExample() {
    const App = () => jsx("div", {
        children: [
            ...
            jsx("ul", {
                children: Array.from({ length: 1000 }, (_, i) => jsx("li", { key: i, children: `Item ${i}` })),
            }),
        ],
    });
 ...
 */
//# sourceMappingURL=streaming-ssr-example.js.map