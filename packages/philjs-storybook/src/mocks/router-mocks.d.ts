 ...
 */
export declare function createMockParams(params: Record<string, string>): any;
/**
 * Create mock search params
 */
export declare function createMockSearchParams(params?: Record<string, string>): any;
