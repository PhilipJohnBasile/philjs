 ...
 * ```
 */
export declare function createStory<P = Record<string, unknown>>(config: StoryConfig<P>): {
    meta: StoryMeta<P>;
    story: (variant?: Partial<StoryConfig<P>>) => StoryVariant<P>;
};
/**
 ...
 */
export declare function createArgs<P extends Record<string, unknown>>(args: P): P;
/**
 * Create argTypes helper (identity with shallow copy).
 */
export declare function createArgTypes(argTypes: Record<string, ArgTypeConfig>): Record<string, ArgTypeConfig>;
/**
 * Create parameters helper (identity with shallow copy).
 */
export declare function createParameters<T extends Record<string, unknown>>(parameters: T): T;
