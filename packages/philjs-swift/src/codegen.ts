...
import type { SwiftProjectConfig, SwiftUIComponent, SignalBinding } from './types.js';
 ...
 */
export function generateSwiftUIComponent(component: SwiftUIComponent): string {
...
function formatSwiftValue(value: unknown, type: string): string {
  if (value === undefined || value === null) {
    if (type === 'string' || type === 'String') return '""';
    if (type === 'number' || type === 'Double') return '0.0';
