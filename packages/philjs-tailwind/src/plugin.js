...
export function philjsTailwindPlugin(options = {}) {
    const { signals = true, components = true, animations = true, forms = true, typography = true, } = options;
    return plugin(function ({ addUtilities, addComponents, addBase, matchUtilities, theme }) {
        // Base styles
        addBase({
            ':root': {
                '--background': '0 0% 100%',
