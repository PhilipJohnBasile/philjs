 ...
 */
export function philjsPreset(options = {}) {
    const { fontFamily = 'Inter, system-ui, sans-serif', primaryColor = 'blue', darkMode = true, colors = {}, borderRadius = 'rounded', spacingScale = 1, } = options;
    const radiusScale = {
        sharp: {
            sm: '0.125rem',
            DEFAULT: '0.25rem',
...
export function createPhilJSPreset(options = {}) {
