 ...
 */
export function toBeInTheDocument(element: Element | null): MatcherResult {
 ...
 */
export function toBeVisible(element: Element | null): MatcherResult {
  if (!element) {
    return {
      pass: false,
 ...
 */
export function toBeDisabled(element: Element | null): MatcherResult {
  if (!element) {
    return {
      pass: false,
 ...
 */
export function toBeEnabled(element: Element | null): MatcherResult {
 ...
 */
export function toHaveFocus(element: Element | null): MatcherResult {
...
export function toHaveValue(
  ...
  let actualValue: string | string[] | number;
  ...
  if (element instanceof HTMLSelectElement && element.multiple) {
    ...
    actualValue = (element as any).value;
  }
 ...
 */
export function toBeChecked(element: Element | null): MatcherResult {
  if (!element) {
    return {
      pass: false,
 ...
 */
export function toBeEmptyDOMElement(element: Element | null): MatcherResult {
  if (!element) {
    return {
      pass: false,
