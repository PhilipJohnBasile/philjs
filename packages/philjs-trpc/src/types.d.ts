...
export type MiddlewareFunction<TContext = BaseContext> = (ctx: TContext, next: () => Promise<unknown>) => Promise<unknown>;
export type ErrorHandler = (error: TRPCClientErrorLike<AnyRouter>, ctx: BaseContext) => void;
...
export interface AdapterConfig {
    ...
    createContext?: (opts: {
        req: Request;
        res?: Response;
    }) => Promise<BaseContext> | BaseContext;
