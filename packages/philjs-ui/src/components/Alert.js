...
export function Alert(props) {
    const { status = 'info', variant = 'subtle', title, children, icon, showIcon = true, dismissible = false, onDismiss, className = '', } = props;
    ...
    return (_jsx("div", { role: "alert", className: `
        ...
        ${className}
      `, children: _jsxs("div", { className: "flex", children: [displayIcon && (_jsx("div", { className: `flex-shrink-0 ${variant === 'solid' ? 'text-white' : styles.icon}`, children: displayIcon })), _jsxs("div", { className: `${displayIcon ? 'ml-3' : ''} flex-1`, children: [title && (_jsx("h3", { className: "font-medium", children: title })), children && (_jsx("div", { className: `${title ? 'mt-1' : ''} text-sm ${variant === 'solid' ? 'text-white/90' : 'opacity-90'}`, children: children }))] }), dismissible && (_jsx("div", { className: "ml-auto pl-3", children: _jsx("button", { type: "button", onClick: handleDismiss, className: `
                inline-flex rounded-md p-1.5
                focus:outline-none focus:ring-2 focus:ring-offset-2
                ${variant === 'solid'
                            ? 'text-white/80 hover:text-white focus:ring-white'
                            : `${styles.icon} hover:opacity-75 focus:ring-current`}
              `, "aria-label": "Dismiss", children: _jsx("svg", { className: "h-4 w-4", fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { fillRule: "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", clipRule: "evenodd" }) }) }) }))] }) }));
}
/**
 * Alert Title
 */
export function AlertTitle(props) {
    return _jsx("h3", { className: "font-medium", children: props.children });
}
/**
 * Alert Description
 */
export function AlertDescription(props) {
    return _jsx("div", { className: "mt-1 text-sm opacity-90", children: props.children });
}
