...
export function Button(props) {
    const { children, variant = 'solid', size = 'md', color = 'primary', disabled = false, loading = false, fullWidth = false, leftIcon, rightIcon, type = 'button', onClick, className = '', style, 'aria-label': ariaLabel, } = props;
  ...
  `.trim().replace(/\s+/g, ' ');
    ...
    return (_jsxs("button", { type: type, disabled: isDisabled, onClick: onClick, className: classes, style: style, "aria-label": ariaLabel, "aria-busy": loading, "aria-disabled": isDisabled, children: [loading && (_jsxs("svg", { className: "animate-spin -ml-1 mr-2 h-4 w-4", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", "aria-hidden": "true", children: [_jsx("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }), _jsx("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })] })), !loading && leftIcon && _jsx("span", { className: "mr-2", children: leftIcon }), children, !loading && rightIcon && _jsx("span", { className: "ml-2", children: rightIcon })] }));
}
/**
...
export function IconButton(props) {
    ...
    return (_jsx(Button, { ...rest, size: size, className: `${iconSizes[size]} ${props.className || ''}`, children: icon }));
}
/**
 * Button Group
 */
export function ButtonGroup(props) {
    ...
    const groupClasses = attached
        ...
        : 'inline-flex gap-2';
    return (_jsx("div", { className: `${groupClasses} ${className}`, role: "group", children: children }));
}
