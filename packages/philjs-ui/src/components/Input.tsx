...
const variantStyles: Record<InputVariant, VariantStyle> = {
  outline: {
    normal:
      'border border-gray-300 rounded-md bg-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500',
    error:
      'border border-red-500 rounded-md bg-white focus:border-red-500 focus:ring-1 focus:ring-red-500',
  },
  filled: {
    normal:
      'border-0 bg-gray-100 rounded-md focus:bg-white focus:ring-2 focus:ring-blue-500',
    error:
      'border-0 bg-red-50 rounded-md focus:bg-white focus:ring-2 focus:ring-red-500',
  },
  flushed: {
    normal:
      'border-0 border-b-2 border-gray-300 rounded-none bg-transparent focus:border-blue-500',
    error:
      'border-0 border-b-2 border-red-500 rounded-none bg-transparent focus:border-red-500',
  },
};
