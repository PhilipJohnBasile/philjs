...
export function Modal(props: ModalProps): JSX.Element | null {
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div
        ref={(el: HTMLDivElement | null) => (modalRef = el)}
        role="dialog"
        aria-modal="true"
 ...
 * Modal Body
 */
export function ModalBody(props: ModalBodyProps): JSX.Element {
  return (
    <div className={`px-4 py-2 ${props.className || ''}`}>{props.children}</div>
  );
}
