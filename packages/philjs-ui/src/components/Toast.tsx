...
toast.success = (options: Omit<ToastOptions, 'status'>) =>
  toast({ ...options, status: 'success' });

toast.error = (options: Omit<ToastOptions, 'status'>) =>
  toast({ ...options, status: 'error' });

toast.warning = (options: Omit<ToastOptions, 'status'>) =>
  toast({ ...options, status: 'warning' });

toast.info = (options: Omit<ToastOptions, 'status'>) =>
