...
export function Tooltip(props) {
    ...
    return (_jsxs("div", { className: "relative inline-block", onMouseEnter: showTooltip, onMouseLeave: hideTooltip, onFocus: showTooltip, onBlur: hideTooltip, children: [children, isVisible() && (_jsxs("div", { role: "tooltip", className: `
            absolute z-50
