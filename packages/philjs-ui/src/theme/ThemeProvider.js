 ...
 */
import { createContext, useContext, signal, effect, onMount } from 'philjs-core';
import { defaultTheme } from './tokens';
const ThemeContext = createContext(null);
export function ThemeProvider(props) {
    const { children, theme: customTheme, defaultColorMode = 'system', storageKey = 'philjs-color-mode', } = props;
    ...
    // Color mode state
    const colorMode = signal(defaultColorMode);
    const resolvedMode = signal('light');
