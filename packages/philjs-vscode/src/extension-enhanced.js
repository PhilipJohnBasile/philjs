...
export function activate(context) {
    ...
    if (enableIntelliSense) {
        // Completion provider
        context.subscriptions.push(vscode.languages.registerCompletionItemProvider(selector, new PhilJSCompletionProvider(), '.', '<', '/', '"', "'"));
        // Hover provider
        context.subscriptions.push(vscode.languages.registerHoverProvider(selector, new PhilJSHoverProvider()));
        // Definition provider
        context.subscriptions.push(vscode.languages.registerDefinitionProvider(selector, new PhilJSDefinitionProvider()));
        // Signature help provider
        context.subscriptions.push(vscode.languages.registerSignatureHelpProvider(selector, new PhilJSSignatureHelpProvider(), '(', ','));
        // Code actions provider
        context.subscriptions.push(vscode.languages.registerCodeActionsProvider(selector, new PhilJSCodeActionsProvider(), {
        ...
        // Formatting provider
        context.subscriptions.push(vscode.languages.registerDocumentFormattingEditProvider(selector, new PhilJSFormattingProvider()));
        context.subscriptions.push(vscode.languages.registerDocumentRangeFormattingEditProvider(selector, new PhilJSRangeFormattingProvider()));
...
function registerCommands(context) {
    // Component creation
    context.subscriptions.push(vscode.commands.registerCommand('philjs.createComponent', async () => {
    ...
    // Route creation
    context.subscriptions.push(vscode.commands.registerCommand('philjs.createRoute', async () => {
        const name = await vscode.window.showInputBox({
    ...
    // Page creation
    context.subscriptions.push(vscode.commands.registerCommand('philjs.createPage', async () => {
        const name = await vscode.window.showInputBox({
    ...
    // Hook creation
    context.subscriptions.push(vscode.commands.registerCommand('philjs.createHook', async () => {
        const name = await vscode.window.showInputBox({
    ...
    // Store creation
    context.subscriptions.push(vscode.commands.registerCommand('philjs.createStore', async () => {
        const name = await vscode.window.showInputBox({
    ...
    // DevTools
    context.subscriptions.push(vscode.commands.registerCommand('philjs.openDevTools', async () => {
        const terminal = vscode.window.createTerminal('PhilJS DevTools');
        terminal.sendText('npx philjs dev');
        terminal.show();
    }));
    // Show commands palette
    context.subscriptions.push(vscode.commands.registerCommand('philjs.showCommands', async () => {
        const items = [
            {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('philjs.wrapInMemo', async (uri, range) => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('philjs.extractToSignal', async (uri, range) => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('philjs.convertToIsland', async (uri, range) => {
...
function updateStatusBar(editor) {
    ...
    const isPhilJSFile = text.includes('@philjs/core') ||
