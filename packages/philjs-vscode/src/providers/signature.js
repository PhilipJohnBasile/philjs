...
export class PhilJSSignatureHelpProvider {
    provideSignatureHelp(document, position, token, context) {
        ...
        if (!info)
            return null;
        const signature = new vscode.SignatureInformation(info.label, new vscode.MarkdownString(info.documentation));
        for (const param of info.parameters) {
            signature.parameters.push(new vscode.ParameterInformation(param.label, new vscode.MarkdownString(param.documentation)));
        }
