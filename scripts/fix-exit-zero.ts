 ...
 *
 * Usage: npx tsx scripts/fix-exit-zero.ts
 */
...
function removeExitZeroPattern(script: string): string {
...
async function processPackageJson(filePath: string): Promise<{ modified: boolean; changes: string[] }> {
